package vn.korapayments.napbank.commands;
...
import vn.korapayments.common.manager.DatabaseManager.TransactionRecord;
import vn.korapayments.common.manager.GUIUtils;
...
public class HistoryCommand implements CommandExecutor {
    ...
    public HistoryCommand(KoraPayments plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length > 0 && player.hasPermission("korapayments.admin")) {
