...
public class AdminCommand implements CommandExecutor, TabCompleter {
    ...
    public AdminCommand(KoraPayments plugin, HistoryCommand historyCommand, MilestoneCommand milestoneCommand) {
        this.plugin = plugin;
    ...
    private boolean hasAdminPermission(CommandSender sender) {
        if (sender.hasPermission("korapayments.admin")) return true;
