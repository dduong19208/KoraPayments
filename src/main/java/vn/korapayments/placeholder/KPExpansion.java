package vn.korapayments.placeholder;
...
public final class KPExpansion extends PlaceholderExpansion {
    ...
    public KPExpansion(KoraPayments plugin) {
        this(plugin, "kp");
    }

    public KPExpansion(KoraPayments plugin, String identifier) {
        this.plugin = plugin;
    ...
    private String resolvePlaceholder(String playerName, String params) {
        ...
        try {
             ...
             */
            if (isKnownKoraPlaceholder(lookupQuery)) {
                return ZERO;
            }
    ...
    private boolean isKnownKoraPlaceholder(String query) {
    ...
    private String normalizeQuery(String input) {
        ...
        } else if (query.startsWith("korapayments_")) {
            query = query.substring("korapayments_".length());
        }
